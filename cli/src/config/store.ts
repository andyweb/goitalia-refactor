...
import { paperclipConfigSchema, type GoItaliaConfig } from "./schema.js";
import {
...
export function resolveConfigPath(overridePath?: string): string {
  ...
  return findConfigFileFromAncestors(process.cwd()) ?? resolveDefaultConfigPath(resolveGoItaliaInstanceId());
}
...
export function readConfig(configPath?: string): GoItaliaConfig | null {
