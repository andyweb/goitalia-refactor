...
import type { AdapterExecutionContext, AdapterExecutionResult } from "@goitalia/adapter-utils";
import type { RunProcessResult } from "@goitalia/adapter-utils/server-utils";
import {
  asString,
  asNumber,
  asBoolean,
