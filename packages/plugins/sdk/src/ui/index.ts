/**
 * `@goitalia/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@goitalia/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@goitalia/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@goitalia/plugin-sdk/ui";
 *
