...
import type { PaperclipPluginManifestV1 } from "@goitalia/shared";
 ...
 * import { startWorkerRpcHost } from "@goitalia/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@goitalia/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
