...
import { execute } from "@goitalia/adapter-gemini-local/server";
...
describe("gemini execute", () => {
  it("passes prompt via --prompt and injects paperclip env vars", async () => {
    ...
    try {
      ...
      expect(promptArg).toContain("GoItalia runtime note:");
      ...
      expect(invocationPrompt).toContain("GoItalia runtime note:");
      expect(invocationPrompt).toContain("PAPERCLIP_API_URL");
      expect(invocationPrompt).toContain("GoItalia API access note:");
