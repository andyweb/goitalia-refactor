...
import { agents as agentsTable, companies, heartbeatRuns } from "@goitalia/db";
...
} from "@goitalia/adapter-utils/server-utils";
...
import { runClaudeLogin } from "@goitalia/adapter-claude-local/server";
import {
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@goitalia/adapter-opencode-local/server";
import {
