...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@goitalia/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@goitalia/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@goitalia/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@goitalia/plugin-hello-world-example",
  ...
  {
    packageName: "@goitalia/plugin-file-browser-example",
  ...
  {
    packageName: "@goitalia/plugin-kitchen-sink-example",
