...
import { companySecrets, companySecretVersions } from "@goitalia/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@goitalia/shared";
import { envBindingSchema } from "@goitalia/shared";
