...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@goitalia/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@goitalia/adapter-utils").TranscriptEntry[];
