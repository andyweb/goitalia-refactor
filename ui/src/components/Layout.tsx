...
function OnboardingTooltipPopup({ companyId, sidebarOpen }: { companyId: string | null; sidebarOpen: boolean }) {
  ...
  const configs: Record<number, { title: string; text: string; top: string }> = {
    0: { title: "Configura API Claude", text: "Per attivare il tuo CEO AI e sbloccare tutte le funzionalita, inserisci la tua API key di Anthropic nella sezione qui sotto.", top: "435px" },
