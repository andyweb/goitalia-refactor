          ...
          <div className="glass-card px-5 py-5 space-y-3">
            <div className="flex items-center gap-4 pb-3 border-b border-white/5">
              <div className="relative shrink-0">
                ...
                {logoUrl && (
                  <button onClick={handleClearLogo} disabled={clearLogoMutation.isPending} className="absolute -top-2 -right-2 rounded-full bg-red-500 hover:bg-red-600 flex items-center justify-center transition-colors shadow-md p-0 aspect-square overflow-hidden" style={{ width: 24, height: 24, minWidth: 24, minHeight: 24 }}>
                    <X className="text-white" style={{ width: 14, height: 14 }} strokeWidth={2.5} />
                  </button>
                )}
              </div>
              <div>
