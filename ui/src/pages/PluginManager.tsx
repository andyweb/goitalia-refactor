...
export function PluginManager() {
  ...
  const connectBtn = (label: string, onClick: () => void) => (
    <button onClick={onClick} className="w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all mt-1" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>{label}</button>
  );
            ...
            <div className="px-4 pb-3 pt-3 space-y-2 border-t border-white/5">
              {isGoogleConnected ? (
                ...
                <button
                  ...
                  style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}
                  onClick={() => {
          ...
          {expandedConnector === "telegram" && (
            <div className="px-4 pb-3 pt-3 space-y-2 border-t border-white/5">
              {isTelegramConnected ? (
                ...
                <button onClick={() => setShowTelegramForm(true)} className="w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all mt-2" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>Collega Bot Telegram</button>
              )}
            </div>
          )}
        </div>
          ...
          {expandedConnector === "whatsapp" && (
            <div className="px-4 pb-3 pt-3 space-y-2 border-t border-white/5">
              {isWaConnected ? (
                ...
                <button onClick={() => setShowWaForm(true)} className="w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all mt-2" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>Collega WhatsApp</button>
              )}
            </div>
          )}
        </div>
            ...
            <div className="px-4 pb-3 pt-3 space-y-2 border-t border-white/5">
              ...
              {isVoiceConnected ? (
                ...
                <div className="space-y-3">
                  ...
                  }} disabled={voiceSaving || !openaiKey.startsWith("sk-")} className="px-4 py-2 rounded-xl text-xs font-medium disabled:opacity-40 transition-all" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>{voiceSaving ? "Verifica..." : "Attiva trascrizione vocali"}</button>
                </div>
              )}
            </div>
          )}
              ...
              {isFalConnected ? (
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={async () => {
                    ...
                    setFalSaving(false);
                  }} disabled={falSaving || !falKey} className="px-4 py-2 rounded-xl text-xs font-medium disabled:opacity-40 transition-all" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>{falSaving ? "Verifica..." : "Collega Fal.ai"}</button>
                </div>
              )}
            </div>
          )}
              ...
              {isFicConnected ? (
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={async () => {
                    ...
                    setFicSaving(false);
                  }} disabled={ficSaving || !ficToken} className="px-4 py-2 rounded-xl text-xs font-medium disabled:opacity-40 transition-all" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>{ficSaving ? "Verifica..." : "Collega Fatture in Cloud"}</button>
                </div>
              )}
            </div>
          )}
                  ...
                  <div key={svc.key} className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
                    ...
                    {isActive ? (
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        }} disabled={oaiSaving || !oaiTokens[svc.key]} className="px-2.5 py-1.5 rounded-lg text-[11px] font-medium disabled:opacity-40 transition-all" style={{ background: "rgba(34, 197, 94, 0.15)", border: "1px solid rgba(34, 197, 94, 0.3)", color: "rgba(255,255,255,0.9)" }}>Aggiungi</button>
                      </div>
                    )}
                  </div>
                );
