 ...
 *
 * Plugin bundles are built with `external: ["@goitalia/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@goitalia/plugin-sdk/ui";
 ...
 * - `import { ... } from "@goitalia/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@goitalia/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@goitalia/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@goitalia/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@goitalia/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@goitalia/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
